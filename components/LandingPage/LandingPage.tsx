import useScript from '@comps/hooks/useScript'
import Image from 'next/image'

const LandingPage = () => {
  useScript('/scripts/landingPageScripts.js')
  return (
    <div className="bg-gradient-to-l from-green-700 to-blue-500">
      ...
      {/* <!--Hero--> */}
      <div className="pt-24">
        <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center h-[800px]">
          {/* <!--Left Col--> */}
          <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
            ...
            <h1 className="my-4 text-5xl font-bold leading-tight">
              Te ayudamos a que tu granja crezca!
            </h1>
            <p className="leading-normal text-2xl mb-8">
              Gesitonar a tus animales, a tu equipo de trabajo, diferentes areas
              y eventos al día!
            </p>
          ...
          {/* <!--Right Col--> */}
          <div className="w-full md:w-3/5 py-6 text-center relative aspect-square ">
            <Image
              src={'/assets/images/HomeVisit/oveja_frente.jpg'}
              fill
              alt="home image"
